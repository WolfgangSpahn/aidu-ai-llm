...
class MathExtractorEvaluator(Evaluator):
    ...
    def extract(self, user_message: str, enforce_json: bool = True) -> list[str]:
        ...
        messages = [
            ...
            {
                "role": "user", 
                "content": f"Extract math expressions from this message:\n\n{user_message}"
            }
        ]
...
def run_smoke_test():
    ...
    test_cases = [
        {
            "message": "The derivative of 3x^2 is 6x",
            "description": "Simple algebraic expression with derivative"
        },
        {
            "message": "Solve the equation 2x + 5 = 13 for x, and then find the integral of 3x^2 dx",
            "description": "Multiple expressions with equation and calculus"
        },
        {
            "message": "I'm not sure about the limit of (1/x) as x approaches infinity",
            "description": "Expression with limit notation"
        },
        {
            "message": "This is just a regular sentence without any math",
            "description": "No mathematical expressions"
        },
    ]
