...
class UncertaintyEvaluator(Evaluator):
    ...
    likert_labels = ["Very well-calibrated", "Well-calibrated", "Neutral", "Poorly-calibrated", "Very poorly-calibrated"]
...
[green]Correct:[/green] {test_case["correct_answer"]}"""
        ...
        distribution = evaluator.evaluate(eval_params={"text": test_case["student_message"], "context": test_case["tutor_message"], "correct_answer": test_case["correct_answer"]})
